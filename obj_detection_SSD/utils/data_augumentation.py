...
class RandomSampleCrop(object):
    ...
    def __init__(self):
        ...
        self.sample_options_idx = [x for x in range(len(self.sample_options))]
    ...
    def __call__(self, image, boxes=None, labels=None):
        ...
        while True:
            ...
            #------------------------------------------------------------------#
            # 2차원 튜플에서 choice()사용에 에러가 발생해 무작위로 index를 뽑아 
            # mode를 설정할 수 있도록 하였다.
            random_idx = random.choice(self.sample_options_idx)
